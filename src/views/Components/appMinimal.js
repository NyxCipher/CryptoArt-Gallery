...
import 'pro-gallery/dist/statics/main.css';
  ...
  { // Image item:
    ...
    metaData: {
      ...
      focalPoint: [0, 0],
      link: {
        url: 'https://lh3.googleusercontent.com/L0VCuV3Rb0SQ6sNaAC6S9Vb8NHc1-UpNMXB3nBVWkwm4lOJoZ07pY0QxMcmzXjaKxAkYKRy1wYyHY_A637Kr1gNTrHo8DNAXLwDu7g=s992',
        target: '_blank'
      },
    }
  },
  { // Video item:
    ...
    metaData: {
      ...
      focalPoint: [0, 0],
      link: {
        url: 'https://media.niftygateway.com/video/upload/v1618196543/Ashley/Pak/Fungible%20Open%20Edition/ACube.mp4',
        target: '_blank'
      },
    }
  },
  ...
  { // Image item:
    itemId: 'sample-id',
    mediaUrl: 'https://lh3.googleusercontent.com/BfemfKxvhKrbiuel8j5Y-xxX_UPBe6FD_x840DuMPvdzDUKqz5zMpAkA84GWDt8FFuZRL_LYLx2KiyFANW2UV5Yd_g=s992',
    metaData: {
      type: 'image',
      height: 300,
      width: 200,
  ...
  { // Image item:
    itemId: 'sample-id',
    mediaUrl: 'https://lh3.googleusercontent.com/AD8IdHXK-LwatmK78HLlUKEAulazbucysd6oCsFtGrQCbKh0uafYkBpTYQ5ByeIiw9UaJGZBIb2b8G4I0laKqFXG=s992',
    metaData: {
      type: 'image',
      height: 300,
      width: 200,
